...
class LynxCheckpointXBlock(XBlock):
    """
    TO-DO: document what your XBlock does.
    """

    display_name = String(
        display_name="LYNX Checkpoint Block",
        help="This name appears in the horizontal navigation at the top of the page",
        scope=Scope.settings,
        default="LYNX Checkpoint Block"
    )
    ...
    def generate_html(html):
        ...
        result = "<div class=\"lynxcheckpoint_xblock\">"
        result += "<div class='lynxcheckpoint_checkpoint'>"
    ...
    def student_view(self, context=None):
        ...
        fragment.add_css(load_resource('static/css/lynxcheckpoint.css'))

        fragment.add_content(Template(body_html).render(Context(content)))
        fragment.add_content(render_template('templates/lynxcheckpoint.html', content))

        fragment.add_javascript(unicode(render_template('static/js/lynxcheckpoint_lms.js', content)))
        fragment.initialize_js('LynxCheckpointXBlock')
    ...
    def studio_view(self, context=None):
        ...
        # Load Studio View
        fragment.add_content(render_template('templates/lynxcheckpoint_edit.html', content))
        fragment.add_css(load_resource('static/css/lynxcheckpoint_edit.css'))
        fragment.add_javascript(unicode(render_template('static/js/lynxcheckpoint_edit.js', content)))
        fragment.initialize_js('LynxCheckpointXBlockStudio')
